# =============================================================================
# SOURCE : cellule 49 du notebook original (notebooks/full_pipeline_original.ipynb)
...
#
# C'est la version DEFINITIVE du masquage (bug pluriel/primitif corrige,
...
results_df.to_csv(OUTPUT_DIR / "multiseed_corrected_masking.csv", index=False)
print(f"\nExporte -> {OUTPUT_DIR / 'multiseed_corrected_masking.csv'}")
